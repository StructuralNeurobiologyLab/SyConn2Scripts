...
try:
    vol1 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/agglo2/agglo2_precomputed_mag1', info=volume_info1, bounded=False, non_aligned_writes=True)
    vol1.provenance.description = 'Whole j0251 segmentation conversion mag 2'
    ...
    vol2 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/agglo2/agglo2_precomputed_mag2/', info=volume_info2, bounded=False, non_aligned_writes=True)
    vol2.provenance.description = 'Whole j0251 segmentation conversion mag 2'
    ...
    vol4 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/agglo2/agglo2_precomputed_mag4/', info=volume_info4, bounded=False, non_aligned_writes=True)
    vol4.provenance.description = 'Whole j0251 segmentation conversion mag 4'
    ...
    vol16 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/agglo2/agglo2_precomputed_mag16/', info=volume_info16, bounded=False, non_aligned_writes=True)
    vol16.provenance.description = 'Whole j0251 segmentation conversion mag 16'
    ...
    vol32 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/agglo2/agglo2_precomputed_mag32/', info=volume_info32, bounded=False, non_aligned_writes=True)
    vol32.provenance.description = 'Whole j0251 segmentation conversion mag 32'
    ...
    vol64 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/agglo2/agglo2_precomputed_mag64/', info=volume_info64, bounded=False, non_aligned_writes=True)
    vol64.provenance.description = 'Whole j0251 segmentation conversion mag 64'
...
def process(z):
    ...
    try:
        ...
        bytes_array = kd.load_seg(offset=(x_start, y_start, z_start), size=size, mag=1)     # Knossos returns zyx arrays
        ...
        # get bytes array from Knossos and reshape it to the according required size
        bytes_array = kd.load_seg(offset=(x_start, y_start, z_start), size=size, mag=2)     # Knossos returns zyx arrays
        bytes_array = np.swapaxes(bytes_array,0,2)                                      # puts it in xyz
        ...
        # get bytes array from Knossos and reshape it to the according required size
        bytes_array = kd.load_seg(offset=(x_start, y_start, z_start), size=size, mag=4)     # Knossos returns zyx arrays
        bytes_array = np.swapaxes(bytes_array,0,2)                                          # puts it in xyz
        ...
        # get bytes array from Knossos and reshape it to the according required size
        bytes_array = kd.load_seg(offset=(x_start, y_start, z_start), size=size, mag=16)     # Knossos returns zyx arrays
        bytes_array = np.swapaxes(bytes_array,0,2)                                          # puts it in xyz
        ...
        # get bytes array from Knossos and reshape it to the according required size
        bytes_array = kd.load_seg(offset=(x_start, y_start, z_start), size=size, mag=32)     # Knossos returns zyx arrays
        bytes_array = np.swapaxes(bytes_array,0,2)                                          # puts it in xyz
        ...
        # get bytes array from Knossos and reshape it to the according required size
        bytes_array = kd.load_seg(offset=(x_start, y_start, z_start), size=size, mag=64)     # Knossos returns zyx arrays
        bytes_array = np.swapaxes(bytes_array,0,2)                                          # puts it in xyz
