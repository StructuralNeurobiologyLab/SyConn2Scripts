...
try:
  ...
  vol8 = CloudVolume('file:///wholebrain/scratch/amancu/j0251/j0251_precomputed_jpeg_mag8/', info=volume_info8, bounded=False, non_aligned_writes=True)
...
with ProcessPoolExecutor(max_workers=140) as executor:
